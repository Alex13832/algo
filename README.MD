...
For documentation and further information see the `doc` path.
...
* BFS shortest path
* Test bipartiteness with BFS
* Nearest neighbor for approximation of the travelling salesman problem
* Dijkstra's algorithm for shortest path finding
* Bellman-Ford's algorithm for shortest path finding
* Floyd-Warshall all node-pairs shortest path
* Prim's algorithm for minimum spanning trees
* Edmond-Karp's algorithm for finding max-flow
* Kosaraju's algorithm for strongly connected components

### Greedy

* Stable matching or stable marriage or the Gale-Shapley algorithm
...
* Convulution with an image kernel
* Gaussian blur
* Median filter
* Binary thresholding
* Adaptive thresholding

### Image object extration
...
* Pascal's triangle
* Computing the angle between the hour and minute hands
* Knapsack
* The Euclidean algorithm for GCD and LCM computation
...
* (Pseudo) Random number distributions
    ...
    * Poisson
    * Geometric
* Sieve of Eratosthenes for computation of prime numbers
...
* Binary
* Selection search, find k-smallest/largest elements in a list
...
<input type="hidden" name="business" value="st.alexander85@gmail.com" />
<input type="hidden" name="item_name" value="A small donation to a happy coder" />
