...
int main() {
	LinkedList<int> *DL = new DoublyLinkedList<int>;
	...
	LinkedList<int> *DL2 = new DoublyLinkedList<int>;
	...
	LinkedList<int> *DL3 = new DoublyLinkedList<int>;
	...
	cout << endl;
	LinkedList<int> *DL4 = new DoublyLinkedList<int>;
	...
	cout << endl;
	LinkedList<int> *DL5 = new DoublyLinkedList<int>;
	...
	LinkedList<int> *DL6 = new DoublyLinkedList<int>;
	...
	LinkedList<int> *DL7 = new DoublyLinkedList<int>;
