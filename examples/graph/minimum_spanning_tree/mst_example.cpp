...
void WriteToFile(const Graph& graph, const vector<DataLine>& lines, const string& filename)
{
  ofstream file;
  file.open(filename);
...
int main(int argc, char* argv[])
{
  ...
  pair<Graph, vector<DataLine>> graph_lines{ReadGraph("testfiles/mst_network_in.csv", nodes)};
